...
5. The generation starts on Meshy.ai's servers and takes 1-3 minutes
6. Progress is shown in the **tracker panel** (bottom-right corner)
7. When complete, the 3D model is automatically downloaded, processed, and attached to the entry
...
- There is a limit on concurrent generation tasks
