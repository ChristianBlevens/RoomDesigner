...
4. Choose whether to **clear furniture** from the photo:
   - **"Clear Furniture"** — AI removes existing furniture and clutter, producing a clean empty room. Best for rooms that are already furnished
